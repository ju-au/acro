...
<footer class="footer">
    ...
    <a href="" class="footer__link footer__link--recruit">
        ...
        <img src="<?php get_template_directory_uri(); ?>/images/footer/arrow-white.png" alt="">
    </a>
    <a href="" class="footer__link footer__link--reserve">
        ...
        <img src="<?php get_template_directory_uri(); ?>/images/footer/arrow-black.png" alt="">
    </a>
    ...
    <div class="inner footer__inner">
        <div class="footer__upper">
            ...
            <!-- /.footer__info -->
            <img class="footer__insta" src="<?php echo get_template_directory_uri(); ?>/images/footer/insta.png" alt="">
        </div>
        <!-- /.footer__upper -->
