...
<footer class="footer" style="background-image: url(<?php echo get_template_directory_uri(); ?>/images/footer/footer-bg.png);">
    ...
    <div class="inner footer__inner">
        <div class="footer__upper">
            ...
            <!-- /.footer__info -->
            <a class="footer__insta" href="https://www.instagram.com/acro_minamikasai"><img src="<?php echo get_template_directory_uri(); ?>/images/footer/insta.png" alt=""></a>
        </div>
        <!-- /.footer__upper -->
        ...
        <div class="footer__lower">
            ...
            <nav class="footer__nav">
                ...
                <ul class="footer__navItems">
                    <li class="footer__navItem"><a href="<?php echo esc_url(home_url('/privacy-policy')); ?>">プライバシーポリシー</a></li>
                </ul>
            </nav>
        </div>
        <!-- /.footer__lower -->
