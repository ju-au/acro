...
<footer class="footer">
    ...
    <div class="footer__buttons-sp is-shown-sp">
        <div class="inner">
...
<nav class="fixedLink">
    <a href="<?php echo esc_url(home_url('/recruit')); ?>" class="fixedLink__recruit is-hidden-sp">
        <p><span>RECRUIT</span><br>採用情報</p>
        <img src="<?php echo get_template_directory_uri(); ?>/images/footer/arrow-white.png" alt="">
    </a>
    <a href="<?php echo esc_url(home_url('/reserve')); ?>" class="fixedLink__reserve is-hidden-sp">
        <figure>
            <img src="<?php echo get_template_directory_uri(); ?>/images/footer/mail.png" alt="">
            <p>メールでの<br>ご予約</p>
        </figure>
